    ...
    <div class="flex">
        ...
        <div class="flex flex-col w-1/2 h-screen justify-center items-center">
            ...
            <form action="#" method="post">
                ...
                <input type="submit" value="SIGN IN" class="w-full h-10 mt-2 rounded-md text-white font-bold text-xl bg-cyan-500">
            </form>
            <p class="text-sm mt-2">You don't have an account? <a href="/sign-up" class="text-cyan-600 font-semibold">Sign Up</a> </p>
        </div>
    </div>

    <div class="w-screen absolute bottom-0 opacity-40 -z-40 -scale-x-100">
